...
const SOCIAL_LINKS = [
  ...
  },
  {
   ...
   {
    name: "Whatsapp",
    href: "https://wa.me/66XXXXXXXXX", // เปลี่ยน XXX ให้เป็นเบอร์โทรของคุณ (มีรหัสประเทศ 66 สำหรับไทย)
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    name: "X",
    href: "https://x.com/your_username", // เปลี่ยน your_username เป็นชื่อผู้ใช้ของคุณ
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    name: "Telegram",
    href: "https://t.me/your_username", // เปลี่ยน your_username เป็นชื่อผู้ใช้ของคุณ
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
